#!/bin/bash
#SBATCH --job-name=holmes_clustering_5_tamaraw   # Job name
...
#SBATCH --output=/home/kka151/projects/def-t55wang/kka151/Website-Fingerprinting-Library/jobs/narval/logs/holmes_clustering_5_tamaraw_%j.log  # Standard output and error log
...
python3 -m exp.dataset_process.gen_early_traffic  --dataset Tik_Tok_30 -cc True
