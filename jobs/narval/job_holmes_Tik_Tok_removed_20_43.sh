#!/bin/bash
#SBATCH --job-name=holmes_tik_tok_removed_20_43   # Job name
...
#SBATCH --output=/home/kka151/projects/def-t55wang/kka151/Website-Fingerprinting-Library/jobs/narval/logs/holmes_tik_tok_removed_20_43_%j.log  # Standard output and error log
